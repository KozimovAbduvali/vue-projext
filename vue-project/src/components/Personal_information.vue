      ...
      <div class="md:w-2/3 lg:w-1/2 space-y-6 lg:ml-auto py-8 lg:py-20 lg:pl-20 xl:pl-28">
        ...
        <div class="border-l border-sky pl-2 md:pl-6  mt-3">
          ...
          <p class="text-brand-dark mt-5">
            ...
            tincidunt. Sem id pellentesque fringilla metus turpis eu ultrices massa turpis. Viverra lacinia ultricies at
            posuere dignissim luctus. Nulla lorem aenean non nibh vel aliquet mattis porta. Quis non nisl non sit. Enim
            mauris diam elementum id a mauris enim orci.
          </p>

          <button class="bg-primary text-white font-roboto rounded transition duration-300 hover:shadow-lg hover:bg-primary/70 px-6 mt-9">
            scopri di più
          </button>
        </div>
      </div>
